    ...
    for y in range(50, 830, 80):
        ...
        for x in range(50, 830, 80):
            ...
            for line in range(lines):
                points = [[start_point_k, y+80], [mid_x_k, mid_y_k], [end_point_k, y+80]]
                py5.no_fill()
                ...
                mid_x_k += factor
            for line in range(lines):
                points = [[x, start_point_cyan], [mid_x_cyan, mid_y_cyan], [x, end_point_cyan]]
                py5.no_fill()
                py5.stroke('#00FFFF')
                py5.begin_shape()
                py5.vertices(points)
            ...
            for line in range(lines):
                points = [[x + 80, start_point_yellow], [mid_x_yellow, mid_y_yellow], [x + 80, end_point_yellow]]
                py5.stroke('#FFFF00')
                py5.begin_shape()
                py5.vertices(points)
                py5.end_shape()
            ...
            for line in range(lines):
                points = [[start_point_magenta, y], [mid_x_magenta, mid_y_magenta], [end_point_magenta, y]]
                py5.stroke('#FF00FF')
                py5.begin_shape()
                py5.vertices(points)
                py5.end_shape()
